...
describe Account::Servers::BannedIpsController do
  login
  ...
  describe "GET #edit" do
    ...
    it "should assign @banned_ips" do
      get :edit, :server_id => @server.id
      assert assigns(:banned_ips)
    end
  end
  ...
  describe "PUT #update" do
    context "after successful update" do
      it "should redirect to the server #show" do
        put :update, :server_id => @server.id, :banned_ips_attributes => {}
